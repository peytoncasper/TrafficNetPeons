...
\newcommand{\productname}{Product Name: Hawkeye}
...
\newcommand{\authors}{Peyton Casper \\ Rabin Dhaubanjar \\ Kyle Edelmann \\ Jose Hernandez \\ Ruchitha Thalakola}
...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.40\textwidth]{images/tp_logo.jpg}
\end{figure}
\vspace{0.5 in}
...
\newpage
\section{Base Station Layer Subsystems}
\input{tex/w_layer_subsystems.tex}
\newpage
\section{Camera Layer Subsystems}
\input{tex/x_layer_subsystems.tex}
\newpage
\section{Wireless Communications Layer Subsystems}
\input{tex/y_layer_subsystems.tex}
\newpage
\section{Web Interface Layer Subsystems}
